...
def main() -> None:
    ...
    title = f"Update `hegel-cpp` docs to v{version}"
    ci_url = "https://github.com/hegeldev/hegel-cpp/blob/main/.github/workflows/ci.yml"
    body = (
        f"Updates [hegel-cpp](https://github.com/hegeldev/hegel-cpp) docs to "
        f"`v{version}`.\n"
        "\n"
        "---\n"
        "\n"
