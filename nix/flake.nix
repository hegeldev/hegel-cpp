{
  ...
  outputs =
    ...
    let
      ...
      libhegelVersion = "0.37.3";
      libhegelAssets = {
        "x86_64-linux" = {
          asset = "libhegel-linux-amd64.so";
          sha256 = "48d8cf719811f288e85cc3e380318a4540a0d03947a97c0b71caf6931561eec0";
        };
        "aarch64-linux" = {
          asset = "libhegel-linux-arm64.so";
          sha256 = "182b05ee427f27602e3e70edfcb1870705d00838d68f5d59c8567fc5db3e0c19";
        };
        "aarch64-darwin" = {
