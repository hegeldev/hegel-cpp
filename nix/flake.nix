{
  ...
  outputs =
    ...
    let
      ...
      libhegelVersion = "0.33.1";
      libhegelAssets = {
        "x86_64-linux" = {
          asset = "libhegel-linux-amd64.so";
          sha256 = "5c7e34f69a8a427f563aa4e8eadec88decb5c1609b17288537527f50556213c3";
        };
        "aarch64-linux" = {
          asset = "libhegel-linux-arm64.so";
          sha256 = "60d33c94b37f1d0e2e8aade1e86d148b01e0646207551225bea55b1095a3655c";
        };
        "aarch64-darwin" = {
          asset = "libhegel-darwin-arm64.dylib";
          sha256 = "07a81062ec037df76ee82c97cbe944beba6c6e44fe21d8f6614d8ad921de6169";
        };
      };
