{
  ...
  outputs =
    ...
    let
      ...
      libhegelVersion = "0.33.4";
      libhegelAssets = {
        "x86_64-linux" = {
          asset = "libhegel-linux-amd64.so";
          sha256 = "c507ffaa9a3c34f60bea6874a186313fb0301d2564cdb0adb9b4a496816d4f7a";
        };
        "aarch64-linux" = {
          asset = "libhegel-linux-arm64.so";
          sha256 = "f82d94c762c29a81519dacc0fbbe23e98e1a16a8e1bc9b78e487454161b6e11b";
        };
        "aarch64-darwin" = {
          asset = "libhegel-darwin-arm64.dylib";
          sha256 = "5f1e11163e7c03d7932f27c1cb3eedd018bcea114ae94c2648f12bdc0dddfacb";
        };
      };
