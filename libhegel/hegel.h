...
/*
 ...
 the call.
 */
typedef void (*hegel_output_callback_t)(void* user_data, const char* line,
                                        size_t len);
...
/*
 ...
 `workload` (database disabled, every health check suppressed). A custom profile
 without an explicit `extends` extends `default`, skipping any candidate already
 in its chain, so it sits on `ci` when resolved on a CI server and on
 `development` locally. The shipped profiles themselves extend `base` and never
 layer over one another. Extending or selecting `base` pins the plain base
 settings.
...
/*
 ...
 Returns `HEGEL_OK`.
 */
hegel_result_t hegel_settings_set_test_cases(hegel_context_t* ctx,
...
hegel_result_t hegel_settings_set_seed(hegel_context_t* ctx,
                                       hegel_settings_t* s, uint64_t seed,
                                       bool has_seed);
 ...
 */
hegel_result_t
hegel_settings_set_test_location(hegel_context_t* ctx, hegel_settings_t* s,
...
hegel_result_t hegel_settings_set_phases(hegel_context_t* ctx,
                                         hegel_settings_t* s, uint32_t phases);
...
/*
 ...
 Returns `HEGEL_OK`.
 */
hegel_result_t hegel_settings_set_print_blob(hegel_context_t* ctx,
 ...
 */
hegel_result_t
hegel_settings_register_profile(hegel_context_t* ctx, const char* name,
...
/*
 ...
 keep their values.
 */
hegel_result_t hegel_set_default_profile(hegel_context_t* ctx,
                                         const char* name);
...
hegel_result_t hegel_settings_get_seed(hegel_context_t* ctx,
                                       const hegel_settings_t* s,
                                       uint64_t* out_seed, bool* out_has_seed);
...
/*
 ...
 Returns `HEGEL_OK`.
 */
hegel_result_t hegel_settings_get_suppress_health_check(
    hegel_context_t* ctx, const hegel_settings_t* s, uint32_t* out);
...
/*
 ...
 Returns `HEGEL_OK`.
 */
hegel_result_t hegel_settings_get_report_multiple_failures(
    hegel_context_t* ctx, const hegel_settings_t* s, bool* out);
...
/*
 ...
 `hegel_run_free`.
 */
hegel_result_t hegel_run_result(hegel_context_t* ctx, hegel_run_t* run,
 ...
 */
hegel_result_t hegel_run_result_free(hegel_context_t* ctx,
 ...
 */
hegel_result_t
hegel_test_case_from_blob(hegel_context_t* ctx, const hegel_settings_t* s,
                          const char* blob, hegel_output_callback_t callback,
                          void* user_data, hegel_test_case_t** out_test_case);
...
/*
 ...
 handle to it.
 */
hegel_result_t hegel_test_case_free(hegel_context_t* ctx,
 ...
 */
hegel_result_t
hegel_test_case_is_nondeterministic(hegel_context_t* ctx,
 ...
 */
hegel_result_t hegel_start_span(hegel_context_t* ctx, hegel_test_case_t* tc,
                                uint64_t label);
 ...
 */
hegel_result_t hegel_stop_span(hegel_context_t* ctx, hegel_test_case_t* tc,
                               bool discard);
...
/*
 ...
 `out_label`.
 */
hegel_result_t hegel_label_from_name(hegel_context_t* ctx, const char* name,
                                     uint64_t* out_label);
 ...
 */
hegel_result_t hegel_label_combine(hegel_context_t* ctx, const uint64_t* labels,
                                   size_t len, uint64_t* out_label);
 ...
 */
hegel_result_t hegel_new_collection(hegel_context_t* ctx, hegel_test_case_t* tc,
 ...
 */
hegel_result_t hegel_collection_free(hegel_context_t* ctx,
                                     hegel_collection_t* collection);
...
/*
 ...
 Returns `HEGEL_OK` or `HEGEL_E_STOP_TEST`.
 */
hegel_result_t hegel_new_recursion(hegel_context_t* ctx, hegel_test_case_t* tc,
                                   uint64_t max_depth, uint64_t max_leaves,
...
hegel_result_t hegel_recursion_branch(hegel_context_t* ctx,
                                      hegel_test_case_t* tc,
                                      HegelRecursion* recursion, uint64_t depth,
                                      bool* out_branch);
 ...
 */
hegel_result_t hegel_recursion_leaf(hegel_context_t* ctx, hegel_test_case_t* tc,
...
/*
 ...
 freed exactly once; freeing the same handle twice is undefined behaviour.
 */
hegel_result_t hegel_recursion_free(hegel_context_t* ctx,
                                    HegelRecursion* recursion);
...
/*
 ...
 Returns `HEGEL_OK` or `HEGEL_E_STOP_TEST`.
 */
hegel_result_t hegel_new_pool(hegel_context_t* ctx, hegel_test_case_t* tc,
                              hegel_pool_t** out_pool);
...
/*
 ...
 Returns `HEGEL_OK` or `HEGEL_E_STOP_TEST`.
 */
hegel_result_t hegel_pool_add(hegel_context_t* ctx, hegel_test_case_t* tc,
                              hegel_pool_t* pool, int64_t* out_variable_id);
...
hegel_result_t hegel_pool_generate(hegel_context_t* ctx, hegel_test_case_t* tc,
                                   hegel_pool_t* pool, bool consume,
 ...
 */
hegel_result_t
hegel_state_machine_next_group(hegel_context_t* ctx, hegel_test_case_t* tc,
 ...
 */
hegel_result_t
hegel_state_machine_next_rule(hegel_context_t* ctx, hegel_test_case_t* tc,
                              hegel_state_machine_t* state_machine,
                              int64_t worker_index, int64_t* out_rule_index);
 ...
 */
hegel_result_t
hegel_state_machine_rule_rejected(hegel_context_t* ctx, hegel_test_case_t* tc,
                                  hegel_state_machine_t* state_machine,
                                  int64_t worker_index);
...
/*
 ...
 regardless of the step count. The caller owns the machine's guaranteed
 invariant checks — its initial state, and its final state once
 ...
 `hegel_mark_complete` with `HEGEL_STATUS_OVERRUN`).
 */
hegel_result_t hegel_state_machine_should_check_invariant(
    hegel_context_t* ctx, hegel_test_case_t* tc,
    hegel_state_machine_t* state_machine, int64_t invariant_index,
...
/*
 ...
 behaviour.
 */
hegel_result_t hegel_state_machine_free(hegel_context_t* ctx,
                                        hegel_state_machine_t* state_machine);
...
hegel_result_t hegel_generate_boolean(hegel_context_t* ctx,
                                      hegel_test_case_t* tc, double p,
                                      bool forced, bool has_forced,
                                      bool* out_value);
...
hegel_result_t hegel_generate_integer(hegel_context_t* ctx,
                                      hegel_test_case_t* tc, int64_t min_value,
...
hegel_result_t hegel_generate_integer_big(
    hegel_context_t* ctx, hegel_test_case_t* tc, const uint8_t* min_value,
    size_t min_value_len, const uint8_t* max_value, size_t max_value_len,
    uint8_t* out_value, size_t out_value_cap, size_t* out_value_len);
...
/*
 ...
 Returns `HEGEL_OK` or `HEGEL_E_STOP_TEST`.
 */
hegel_result_t hegel_generate_float(hegel_context_t* ctx, hegel_test_case_t* tc,
                                    uint32_t width, double min_value,
                                    double max_value, bool allow_nan,
                                    bool allow_infinity, bool exclude_min,
                                    bool exclude_max,
...
/*
 ...
 Returns `HEGEL_OK` or `HEGEL_E_STOP_TEST`.
 */
hegel_result_t hegel_generate_bytes(hegel_context_t* ctx, hegel_test_case_t* tc,
                                    uint64_t min_size, uint64_t max_size,
 ...
 */
hegel_result_t
hegel_generate_bytes_result_free(hegel_context_t* ctx,
...
hegel_result_t hegel_string_generator_text(
    hegel_context_t* ctx, uint64_t min_size, uint64_t max_size,
    const char* codec, uint32_t min_codepoint, uint32_t max_codepoint,
    const char* const* categories, size_t categories_len,
    const char* const* exclude_categories, size_t exclude_categories_len,
    const uint8_t* include_characters, size_t include_characters_len,
    const uint8_t* exclude_characters, size_t exclude_characters_len,
 ...
 */
hegel_result_t
hegel_string_generator_regex(hegel_context_t* ctx, const char* pattern,
                             bool fullmatch,
 ...
 */
hegel_result_t
hegel_string_generator_email(hegel_context_t* ctx,
                             hegel_string_generator_t** out_generator);
 ...
 */
hegel_result_t
hegel_string_generator_url(hegel_context_t* ctx,
                           hegel_string_generator_t** out_generator);
 ...
 */
hegel_result_t
hegel_string_generator_domain(hegel_context_t* ctx, uint64_t max_length,
                              hegel_string_generator_t** out_generator);
 ...
 */
hegel_result_t
hegel_generate_string(hegel_context_t* ctx, hegel_test_case_t* tc,
 ...
 */
hegel_result_t
hegel_generate_string_result_free(hegel_context_t* ctx,
...
/*
 ...
 range.
 */
hegel_result_t hegel_generate_date(hegel_context_t* ctx, hegel_test_case_t* tc,
 ...
 */
hegel_result_t hegel_generate_time(hegel_context_t* ctx, hegel_test_case_t* tc,
...
/*
 ...
 Returns `HEGEL_OK` or `HEGEL_E_STOP_TEST`.
 */
hegel_result_t hegel_generate_uuid(hegel_context_t* ctx, hegel_test_case_t* tc,
                                   uint8_t version, bool has_version,
                                   uint8_t* out_bytes);
...
/*
 ...
 Returns `HEGEL_OK` or `HEGEL_E_STOP_TEST`.
 */
hegel_result_t hegel_generate_ipv4(hegel_context_t* ctx, hegel_test_case_t* tc,
                                   uint8_t* out_bytes);
...
/*
 ...
 Returns `HEGEL_OK` or `HEGEL_E_STOP_TEST`.
 */
hegel_result_t hegel_generate_ipv6(hegel_context_t* ctx, hegel_test_case_t* tc,
                                   uint8_t* out_bytes);
 ...
 */
hegel_result_t hegel_target(hegel_context_t* ctx, hegel_test_case_t* tc,
...
/*
 ...
 label.
 */
hegel_result_t hegel_event(hegel_context_t* ctx, hegel_test_case_t* tc,
                           const char* label);
 ...
 */
hegel_result_t hegel_event_value(hegel_context_t* ctx, hegel_test_case_t* tc,
                                 double value, const char* label);
 ...
 */
hegel_result_t hegel_printer_options_free(hegel_context_t* ctx,
 ...
 */
hegel_result_t hegel_printer_options_set_max_width(
    hegel_context_t* ctx, hegel_printer_options_t* options, uint64_t max_width);
 ...
 */
hegel_result_t hegel_printer_free(hegel_context_t* ctx,
...
hegel_result_t hegel_printer_text(hegel_context_t* ctx,
                                  hegel_printer_t* printer, const uint8_t* text,
                                  size_t len);
 ...
 */
hegel_result_t hegel_printer_hard_break(hegel_context_t* ctx,
                                        hegel_printer_t* printer);
...
hegel_result_t hegel_printer_begin_group(hegel_context_t* ctx,
                                         hegel_printer_t* printer,
                                         uint64_t indent, const uint8_t* open,
                                         size_t open_len);
...
hegel_result_t hegel_printer_end_group(hegel_context_t* ctx,
                                       hegel_printer_t* printer,
                                       const uint8_t* close, size_t close_len);
...
/*
 ...
 handle.
 */
hegel_result_t hegel_printer_begin_speculative(hegel_context_t* ctx,
                                               hegel_printer_t* printer);
...
/*
 ...
 open.
 */
hegel_result_t hegel_printer_commit_speculative(hegel_context_t* ctx,
                                                hegel_printer_t* printer);
...
/*
 ...
 open.
 */
hegel_result_t hegel_printer_abort_speculative(hegel_context_t* ctx,
                                               hegel_printer_t* printer);
 ...
 */
hegel_result_t hegel_printer_resolve(hegel_context_t* ctx,
                                     hegel_printer_t* printer);
...
hegel_result_t hegel_printer_is_live(hegel_context_t* ctx,
                                     hegel_printer_t* printer, bool* out_live);
 ...
 */
hegel_result_t
hegel_printer_value_result_free(hegel_context_t* ctx,
...
/*
 ...
 `text` with `len > 0`.
 */
hegel_result_t hegel_note(hegel_context_t* ctx, hegel_test_case_t* tc,
                          const uint8_t* text, size_t len);
...
/*
 ...
 Choosing an origin string: libhegel groups failures by their `origin`. Two
 failures with identical origins are the same bug and get shrunk together. Each
 new origin is a new bug.

 A library must pass a stable value for the origin, such as the location
 of the failing assertion.
 */
hegel_result_t hegel_mark_complete(hegel_context_t* ctx, hegel_test_case_t* tc,
                                   uint32_t status, const char* origin);
