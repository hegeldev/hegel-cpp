...
namespace hegel::internal {
    ...
    StateMachineHandle::StateMachineHandle(
        ...
        // A NULL `rule_weights` array selects every enabled rule with equal
        // weight; the public API exposes no per-rule weight. A NULL
        // `invariant_always_check` array leaves every invariant sampled at its
        // default probability; the public API exposes no always-check flag. The
        // step budget is Settings::stateful_step_count, carried on the test
        // case.
