...
namespace hegel::internal {
    ...
    class StateMachineHandle {
      public:
        ...
        // Starts the next round: makes the per-round stop decision, and
        // returns the current group id, or state_machine_done once the
        // machine is complete. Call at each join point, including before
        // the first rule.
