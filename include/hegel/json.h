...
namespace hegel::internal::json {
    ...
    class json {
        ...
        public:
            ...
            std::string value(const std::string& key, const std::string& default_value);
    ...
    public:
        ...
        template <
            class... Args,
            std::enable_if_t<std::is_constructible<json, Args...>::value, int> = 0 >
        json_ref(Args && ... args)
