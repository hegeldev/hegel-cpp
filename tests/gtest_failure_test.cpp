// gtest_failure_test.cpp - Tests that hegel properly reports failures with counterexamples
//
...
//
// This test is registered with WILL_FAIL in CMake, so it "passes" when it fails.
